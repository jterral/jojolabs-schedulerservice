...
namespace JojoLabs.SchedulerService.Cron
{
    ...
    public sealed class CrontabField
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrontabField"/> class.
        /// </summary>
        /// <param name="impl">The Crontab implementation.</param>
        /// <param name="expression">The expression.</param>
        /// <exception cref="ArgumentNullException">Crontab implementation is null.</exception>
        ...
        /// <summary>
        /// Gets the next value of the field that occurs after the given start value or -1 if there is no next value available.
        /// </summary>
        ...
        /// </summary>
        /// <param name="kind">The Crontab kind.</param>
        /// <param name="expression">The expression.</param>
        ...
        /// </summary>
        /// <param name="expression">The expression.</param>
        /// <returns>The <see cref="CrontabField"/> representing minutes.</returns>
        ...
        /// </summary>
        /// <param name="expression">The expression.</param>
        /// <returns>The <see cref="CrontabField"/> representing hours.</returns>
        ...
        /// </summary>
        /// <param name="expression">The expression.</param>
        /// <returns>The <see cref="CrontabField"/> representing days.</returns>
        ...
        /// </summary>
        /// <param name="expression">The expression.</param>
        /// <returns>The <see cref="CrontabField"/> representing months.</returns>
        ...
        /// </summary>
        /// <param name="expression">The expression.</param>
        /// <returns>The <see cref="CrontabField"/> representing days of week.</returns>
        ...
        /// <summary>
        /// Accumulates the given range (start to end) and interval of values into the current set of the field.
        /// </summary>
        /// <param name="start">The start range.</param>
        /// <param name="end">The end range.</param>
        /// <param name="interval">The interval.</param>
        /// <exception cref="FormatException">Format unknown.</exception>
        /// <remarks>
        /// To set the entire range of values representable by the field, set <param name="start"/> and <param name="end"/> to -1
        /// and <param name="interval"/> to 1.
        /// </remarks>
        private void Accumulate(int start, int end, int interval)
        {
            ...
            // Make sure we remember the minimum value set so far Keep track of the highest and lowest values that have been added
            // to this field so far.
